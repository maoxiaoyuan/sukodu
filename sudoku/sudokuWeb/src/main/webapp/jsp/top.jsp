...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="<%=request.getContextPath()%>/house/houseList" style="height:65%;"><img src="img/logo11.png" alt=""></a>
            ...
            <ul class="navbar-nav">
                ...
                <c:if test="${USER !=null}">
                    <li class="nav-item"><a class="nav-link" href="#">
                        ...
                        <div style=" width:50px;height:50px;float: left;border-radius: 50%;position: relative;top:5px;left: 10px;"><img src="${USER.headPhoto}" class="img-circle" style="width: 100%;height: 100%;" >
                        </div>
                    </a>
